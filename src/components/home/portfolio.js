...
function Portfolio() {
  ...
  return (
    <section
      className="px-4 py-8 flex flex-col gap-6 md:justify-center transition-class justify-start items-center min-h-screen w-full mt-28 rounded-[4rem] flex-wrap md:flex-nowrap overflow-hidden mesh-gradient relative"
      id="portfolio"
    >
